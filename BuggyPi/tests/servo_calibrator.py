...
# obtained by measuring the x offset created by the servo
# in its left and right most positions.
# asin(x offset / wheel steering arm length) = angle
left_angle = 0.81096
right_angle = -0.53719
left_value = 35
right_value = -25
...
def joy_changed(axis, value, params):
    ...
    if axis == "left x":
        ...
        print(math.degrees(servo_to_angle(servo.get())))
