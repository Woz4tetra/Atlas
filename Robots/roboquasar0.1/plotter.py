...
robot = RoboQuasar(True, "buggy 2", enable_cameras=False, use_log_file_maps=True, show_cameras=True)
robot.manual_mode = False
# robot.bozo_filter.init_compass("200")
simulator = RobotSimulator(file_name, directory, robot, debug_enabled=False, start_index=35000)
