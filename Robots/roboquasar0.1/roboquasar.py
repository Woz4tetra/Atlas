...
class RoboQuasar(Robot):
    def __init__(self, enable_plotting, map_set_name,
        ...
        self.left_camera = Camera("leftcam", enabled=enable_cameras, show=show_cameras, width=320, height=240, skip_count=15)
        self.right_camera = Camera("rightcam", enabled=enable_cameras, show=show_cameras, width=320, height=240, skip_count=15)
...
video_sets = {
    "rolls day 5": (
        ("06_50_49", "rolls/2017_Mar_26", "mp4"), #0
        ("06_58_20", "rolls/2017_Mar_26", "mp4"), #1
        ("06_58_40", "rolls/2017_Mar_26", "mp4"), #2
        ("06_59_35", "rolls/2017_Mar_26", "mp4"), #3
        ("07_02_52", "rolls/2017_Mar_26", "mp4"), #4
        ("07_05_26", "rolls/2017_Mar_26", "mp4"), #5
        ("07_07_44", "rolls/2017_Mar_26", "mp4"), #6
        ("07_09_51", "rolls/2017_Mar_26", "mp4"), #7
        ("07_29_36", "rolls/2017_Mar_26", "mp4"), #8
        ("07_30_06", "rolls/2017_Mar_26", "mp4"), #9
        ("07_30_42", "rolls/2017_Mar_26", "mp4"), #10
        ("07_36_11", "rolls/2017_Mar_26", "mp4"), #11
        ("07_37_24", "rolls/2017_Mar_26", "mp4"), #12
        ("07_42_24", "rolls/2017_Mar_26", "mp4"), #13
        ("08_56_07", "rolls/2017_Mar_26", "mp4"), #14
    ),
