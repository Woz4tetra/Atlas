...
void Adafruit_BMP280::readCoefficients(void)
{
    ...
    Serial.println(_bmp280_calib.dig_T1);
    Serial.println(_bmp280_calib.dig_T2);
    Serial.println(_bmp280_calib.dig_T3);
    Serial.println(_bmp280_calib.dig_P1);
    Serial.println(_bmp280_calib.dig_P2);
    Serial.println(_bmp280_calib.dig_P3);
    Serial.println(_bmp280_calib.dig_P4);
    Serial.println(_bmp280_calib.dig_P5);
    Serial.println(_bmp280_calib.dig_P6);
    Serial.println(_bmp280_calib.dig_P7);
    Serial.println(_bmp280_calib.dig_P8);
    Serial.println(_bmp280_calib.dig_P9);
}
