...
def plot_angles(file_name, density=100):
    timestamps, sensor_data = get_plottable_data(file_name, ["lat", "long", "compass"])
    # interpreter = Interpreter(0, sensor_data[0][0], sensor_data[1][0], sensor_data[3][0])
