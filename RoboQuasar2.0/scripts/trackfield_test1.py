...
k_filter = MainFilter(gps['lat_sec'], gps['long_sec'], 1, 0)
...
try:
    while True:
        ...
        # (x, y, phi) = k_filter.update(gps["lat_sec"], gps["long_sec"], encoder["counts"], imu["accel_x"], imu["accel_y"], imu["gyro_y"], imu['yaw'] * math.pi / 180)
